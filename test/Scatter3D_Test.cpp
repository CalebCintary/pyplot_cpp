...
BOOST_AUTO_TEST_SUITE(Scatter3D_Test)

    BOOST_AUTO_TEST_CASE(Scatter3D_SimpleShow_Test) {
        pyplot_cpp::Scatter3D plot;
        int a = 0;
        int b = 0;
        std::vector<double> z;
        std::vector<double> r;
    ...
    BOOST_AUTO_TEST_CASE(Scatter3D_SimpleSave_Test) {
        pyplot_cpp::Scatter3D plot;
        int a = 0;
        int b = 0;
        std::vector<double> z;
        ...
        plot.setData(x, y, z);
        plot.save("../../examples/Scatter3D_simple.png");
    }
